...
for F in $FS; do
  for T in $TS; do
    ./prl_bench ../workloads/cut-$F-$2-$1.bin $T 8
    ./prl_bench ../workloads/cut-$F-$3-$1.bin $T 8
    ./prl_bench ../workloads/cut-$F-$2-$1.bin $T 16
    ./prl_bench ../workloads/cut-$F-$3-$1.bin $T 16
    ./prl_bench ../workloads/cut-$F-$2-$1.bin $T 32
    ./prl_bench ../workloads/cut-$F-$3-$1.bin $T 32
  done;
done;
